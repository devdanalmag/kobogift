...
const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: "Building decentralized payment rails, smart contract architecture, and seamless Web3 onboarding.",
    avatarInitials: "MA",
  ...
  },
  {
    ...
    handle: "@ArewA_96",
    role: "Core Contributor",
    bio: "Full-stack protocol engineer focused on gasless execution, real-time settlement, and user experience.",
    avatarInitials: "AR",
  ...
  },
  {
    ...
    handle: "@nunu_mar",
    role: "Core Contributor",
    bio: "Product strategist and ecosystem builder scaling viral distribution and digital cash adoption.",
    avatarInitials: "NM",
